...
public class MethodsSolutionsPart1 {
	 ...
	 * Outputs to the screen ìoddî or ìevenî.
	 * 
	 * @param number
	...
	/**
	 * Determines if it is currently AM or PM. If AM then it output is ìGood
	 * morningî and if PM then ìI hope the morning went well for you. Enjoy the
	 * rest of your day.î
	 */
