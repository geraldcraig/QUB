...
public class Areas extends BoardLocation {
	...
	protected int percentageReturnOfInvestment;
	 ...
	 * @param purchasePrice
	 */
	public Areas(int index, String areaName, String areaField, int purchasePrice, int percentageReturnOfInvestment, double percentageLicenseFee, int minorDevPurchaseCost,
	 ...
	 */
	public  int getPercentageReturnOfInvestment() {
	...
	/**
	 * takes in percentageReturnOfInvestment and purchase price and works out return of investment for pass go collect more doe
	 * @param percentageReturnOfInvestment
	 * @param purchasePrice
	 * @return
	 */
	public int calculateInvestmentReturn(int percentageReturnOfInvestment, int purchasePrice) {
		
		this.purchasePrice = purchasePrice;
		int investmentReturn;

		investmentReturn = (purchasePrice / 100) * percentageReturnOfInvestment;
