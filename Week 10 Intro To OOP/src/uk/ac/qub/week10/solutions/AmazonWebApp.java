...
/**
 * Creates (Tests) the two books and also has a compare field (no. of pages methodO
 * @author 3048360
 *
 */
public class AmazonWebApp {
	...
	public static void main(String[] args) {
		...
		AmazonBook book2 = new AmazonBook("Ulysses", "James Joyce", 2.25, 736, "English", "1840226358", 5);
