...
class BoardTest {
	...
	Areas falls = new Areas(1, "Falls", "West Belfast", 20, .05, 40, .02, 80, .08);
	Areas shankill = new Areas(2, "Shankill", "West Belfast", 40, .05, 40, .02, 80, .08);
	Areas castleView = new Areas(3, "Castle View", "North Belfast", 60, .10, 60, .03, 120, .12);
	Areas caveHill= new Areas(4, "Cave Hill", "North Belfast", 80, .10, 60, .03, 120, .12);
	Areas waterWorks = new Areas(5, "Water Works", "North Belfast", 100, .10, 60, .03, 120, .12);
	Areas titanic = new Areas(7, "Titanic", "East Belfast", 120, .15, 80, .04, 160, .16);
	Areas victoriaStation = new Areas(8, "Victoria-Station", "East Belfast", 140, .15, 80, .04, 160, .16);
	Areas airportRoad = new Areas(9, "Airport Road", "East Belfast", 160, .15, 80, .04, 160, .16);
	Areas universitySquare = new Areas(10, "University Square", "South Belfast", 180, .20, 100, .05, 200, .20);
	Areas botanic = new Areas(11, "Botanic", "South Belfast", 200, .20, 100, .05, 200, .20);
